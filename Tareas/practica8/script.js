...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateThemeIcon(theme) {
        if (theme === 'dark') {
            ...
            themeToggleBtn.innerHTML = `
                <svg viewBox="0 0 24 24"><path d="M12.3 22h-.1c-5.5 0-10-4.5-10-10 0-4.8 3.5-8.9 8.2-9.8.6-.1 1.2.3 1.3.9.1.6-.2 1.2-.8 1.4-3.1 1-5.3 3.9-5.3 7.3 0 4.1 3.4 7.5 7.5 7.5 3.4 0 6.3-2.2 7.3-5.3.2-.6.8-.9 1.4-.8.6.1 1 .7.9 1.3-.9 4.7-5 8.2-9.8 8.2z"/></svg>
            `;
        }
    }
